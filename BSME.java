...
public class BSME extends student {

	String teacherNM, teacherDept;
	private GradeClass FinalGrade;
	
	public BSME(String lname, String fname, int age, String addr, String telnum,
	...
	public BSME(String scode, String ycode, String ccode) {
